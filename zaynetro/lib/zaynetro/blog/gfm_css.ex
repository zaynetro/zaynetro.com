defmodule Zaynetro.Blog.GfmCss do
  ...
  .markdown-body a  { color: #0969da; text-decoration: underline; }
  .markdown-body a:hover { color: #0550ae; }
  .dark .markdown-body a { color: #58a6ff; }
  .dark .markdown-body a:hover { color: #79c0ff; }
  .markdown-body blockquote {
    padding: 0 1em; color: #57606a;
    border-left: .25em solid #d0d7de; margin: 0 0 1em;
  }
  .dark .markdown-body blockquote { color: #8b949e; border-left-color: #3d444d; }
  ...
  .dark .markdown-body hr { border-top-color: #3d444d; }
  ...
  .dark .markdown-body code:not(pre code) { background-color: rgba(110,118,129,.4); }
  """
  ...
  .dark .markdown-body .img-block-label { color: #8b949e; }
  """
